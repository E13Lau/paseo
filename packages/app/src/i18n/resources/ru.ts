...
export const ru: TranslationResources = {
  ...
  workspace: {
    ...
    scripts: {
      ...
      accessibility: {
        ...
        forwardPort: "Пробросить порт {{scriptName}}",
  ...
  settings: {
    ...
    savedPrompts: {
      ...
      listTitle: "Промпты",
      add: "Добавить сохранённый промпт",
      newPrompt: "Новый промпт",
      empty: "Сохранённых промптов пока нет",
      saveError: "Не удалось сохранить промпты",
      automaticSending: {
        label: "Автоматическая отправка",
        description: "Сразу отправлять выбранный сохранённый промпт",
      },
      actions: {
        reorder: "Изменить порядок {{name}}",
        reorderHint: "Перетащите, чтобы изменить положение",
      ...
      remove: {
        title: "Удалить {{name}}?",
        message: "Сохранённый промпт будет удалён из этого клиента.",
        confirm: "Удалить",
      },
      validation: {
        nameRequired: "Введите название",
        nameDuplicate: "Название должно быть уникальным",
        bodyRequired: "Промпт должен содержать текст",
      },
      form: {
        createTitle: "Новый сохранённый промпт",
        editTitle: "Изменить сохранённый промпт",
        nameLabel: "Название",
        namePlaceholder: "Короткое узнаваемое название",
        bodyLabel: "Промпт",
        bodyPlaceholder: "Повторно используемый текст промпта",
        save: "Сохранить",
        saving: "Сохранение...",
      },
    },
    ...
    host: {
      ...
      ports: {
        title: "Порты",
        sectionTitle: "Проброс портов",
        add: "Добавить проброс",
        addTitle: "Новый проброс порта",
        editTitle: "Изменить проброс порта",
        target: "Адрес Host",
        label: "Метка",
        localPort: "Локальный порт",
        localPortPlaceholder: "Как у цели",
        requireLocalPort: "Требовать локальный порт",
        openAs: "Открыть как",
        openAsNone: "Нет",
        save: "Сохранить",
        copy: "Копировать",
        ...
        errors: {
          target: "Укажите порт или host:port",
          port: "Порт должен быть от 1 до 65535",
        },
        states: {
          starting: "Запуск",
          waiting: "Ожидание Host",
          updateHost: "Требуется обновление Host",
          ready: "Готово",
          unavailable: "Порт недоступен",
          error: "Ошибка",
        },
      },
      connections: {
      ...
      instructionFiles: {
        sectionTitle: "Файлы инструкций",
        hint: "Markdown-файлы, которые Provider уже загружает из пользовательской области на этом Host.",
        appliesAfterSave: "Изменения применяются к сессиям агента, запущенным после сохранения.",
        unavailable: "Подключитесь к этому хосту, чтобы редактировать файлы инструкций",
        unsupported: "Обновите этот хост, чтобы редактировать файлы инструкций",
        empty: "На этом хосте нет файлов инструкций.",
        missing: "Отсутствует",
        providers: "Загружают {{providers}}",
        loadFailed: "Не удалось загрузить этот файл инструкций.",
        accessibilityLabel: "Пользовательский файл инструкций {{filename}}",
        placeholder: "Инструкции, которые Provider загружает из этого файла.",
        reset: "Сбросить",
        save: "Сохранить",
        saving: "Сохранение...",
        saveFailed: "Не удалось сохранить этот файл инструкций.",
        conflictTitle: "Файл изменился на диске",
        conflictDescription: "Перезагрузите текущий файл или перезапишите его своим черновиком.",
        reload: "Перезагрузить",
        overwrite: "Перезаписать",
      },
      agents: {
