...
export const zhCN: TranslationResources = {
  ...
  settings: {
    ...
    savedPrompts: {
      ...
      remove: {
        title: "移除 {{name}}？",
        message: "这会从当前客户端移除此快捷短语。",
        confirm: "移除",
      },
      validation: {
        nameRequired: "名称不能为空",
        nameDuplicate: "名称必须唯一",
        bodyRequired: "短语内容不能为空",
      },
      form: {
        createTitle: "新建快捷短语",
        editTitle: "编辑快捷短语",
        nameLabel: "名称",
        namePlaceholder: "简短易识别的名称",
        bodyLabel: "短语内容",
        bodyPlaceholder: "可重复使用的提示词",
        save: "保存",
        saving: "正在保存...",
      },
    },
    ...
    host: {
      ...
      ports: {
        ...
        label: "标签",
        localPort: "本地端口",
        localPortPlaceholder: "与目标相同",
        requireLocalPort: "要求本地端口",
        openAs: "打开为",
        openAsNone: "无",
        save: "保存",
        copy: "复制",
      ...
      instructionFiles: {
        sectionTitle: "指令文件",
        hint: "Provider 已从此 Host 的用户范围加载的 Markdown 文件。",
        appliesAfterSave: "编辑会应用到保存后启动的 Agent 会话。",
        unavailable: "连接到这个 Host 以编辑指令文件",
        unsupported: "更新这个 Host 以编辑指令文件",
        empty: "此 Host 上没有指令文件。",
        missing: "缺失",
        providers: "由 {{providers}} 加载",
        loadFailed: "无法加载此指令文件。",
        accessibilityLabel: "用户指令文件 {{filename}}",
        placeholder: "Provider 从此文件加载的指令。",
        reset: "重置",
        save: "保存",
        saving: "保存中...",
        saveFailed: "无法保存此指令文件。",
        conflictTitle: "磁盘上的文件已更改",
        conflictDescription: "重新加载当前文件，或用草稿覆盖它。",
        reload: "重新加载",
        overwrite: "覆盖",
      },
      agents: {
