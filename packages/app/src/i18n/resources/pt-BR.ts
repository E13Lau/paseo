...
export const ptBR: TranslationResources = {
  ...
  workspace: {
    ...
    scripts: {
      ...
      accessibility: {
        ...
        forwardPort: "Encaminhar porta de {{scriptName}}",
  ...
  settings: {
    ...
    savedPrompts: {
      ...
      listTitle: "Prompts",
      add: "Adicionar prompt salvo",
      newPrompt: "Novo prompt",
      empty: "Nenhum prompt salvo ainda",
      saveError: "Não foi possível salvar os prompts",
      automaticSending: {
        label: "Envio automático",
        description: "Enviar um prompt salvo imediatamente ao selecioná-lo",
      },
      actions: {
        reorder: "Reordenar {{name}}",
        reorderHint: "Arraste para mudar a posição",
      ...
      remove: {
        title: "Remover {{name}}?",
        message: "Isso remove o prompt salvo deste cliente.",
        confirm: "Remover",
      },
      validation: {
        nameRequired: "O nome é obrigatório",
        nameDuplicate: "O nome deve ser único",
        bodyRequired: "O prompt deve conter texto",
      },
      form: {
        createTitle: "Novo prompt salvo",
        editTitle: "Editar prompt salvo",
        nameLabel: "Nome",
        namePlaceholder: "Nome curto e reconhecível",
        bodyLabel: "Prompt",
        bodyPlaceholder: "Texto reutilizável do prompt",
        save: "Salvar",
        saving: "Salvando...",
      },
    },
    ...
    host: {
      ...
      ports: {
        title: "Portas",
        sectionTitle: "Encaminhamentos de porta",
        add: "Adicionar encaminhamento",
        addTitle: "Novo encaminhamento de porta",
        editTitle: "Editar encaminhamento de porta",
        target: "Endereço do Host",
        label: "Rótulo",
        localPort: "Porta local",
        localPortPlaceholder: "Igual ao destino",
        requireLocalPort: "Exigir porta local",
        openAs: "Abrir como",
        openAsNone: "Nenhum",
        save: "Salvar",
        copy: "Copiar",
        ...
        errors: {
          target: "Use uma porta ou host:porta",
          port: "A porta deve estar entre 1 e 65535",
        },
        states: {
          starting: "Iniciando",
          waiting: "Aguardando o Host",
          updateHost: "Atualização do Host necessária",
          ready: "Pronto",
          unavailable: "Porta indisponível",
          error: "Erro",
        },
      },
      connections: {
      ...
      instructionFiles: {
        sectionTitle: "Arquivos de instruções",
        hint: "Arquivos markdown que um Provider já carrega do escopo do usuário neste Host.",
        appliesAfterSave: "As edições se aplicam às sessões de agente iniciadas após salvar.",
        unavailable: "Conecte-se a este host para editar os arquivos de instruções",
        unsupported: "Atualize este host para editar os arquivos de instruções",
        empty: "Não há arquivos de instruções neste host.",
        missing: "Ausente",
        providers: "Carregado por {{providers}}",
        loadFailed: "Não foi possível carregar este arquivo de instruções.",
        accessibilityLabel: "Arquivo de instruções do usuário {{filename}}",
        placeholder: "Instruções que o Provider carrega deste arquivo.",
        reset: "Redefinir",
        save: "Salvar",
        saving: "Salvando...",
        saveFailed: "Não foi possível salvar este arquivo de instruções.",
        conflictTitle: "O arquivo mudou no disco",
        conflictDescription: "Recarregue o arquivo atual ou substitua-o pelo seu rascunho.",
        reload: "Recarregar",
