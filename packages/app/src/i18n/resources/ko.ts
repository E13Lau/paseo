...
export const ko: TranslationResources = {
  ...
  settings: {
    ...
    savedPrompts: {
      ...
      saveError: "저장된 프롬프트를 저장할 수 없습니다",
      automaticSending: {
        label: "자동 전송",
        description: "저장된 프롬프트를 선택하면 즉시 전송합니다",
      },
      actions: {
        reorder: "{{name}} 순서 변경",
        reorderHint: "드래그하여 위치 변경",
        moveUp: "{{name}} 위로 이동",
      ...
      remove: {
        ...
        message: "이 클라이언트에서 저장된 프롬프트를 삭제합니다.",
        confirm: "삭제",
      },
      validation: {
        nameRequired: "이름은 필수입니다",
        nameDuplicate: "이름은 고유해야 합니다",
        bodyRequired: "프롬프트에 텍스트가 있어야 합니다",
      },
      form: {
        createTitle: "새 저장된 프롬프트",
        editTitle: "저장된 프롬프트 편집",
        nameLabel: "이름",
        namePlaceholder: "짧고 알아보기 쉬운 이름",
        bodyLabel: "프롬프트",
        bodyPlaceholder: "재사용할 프롬프트 텍스트",
        save: "저장",
        saving: "저장 중...",
      },
    },
    ...
    host: {
      ...
      ports: {
        ...
        label: "레이블",
        localPort: "로컬 포트",
        localPortPlaceholder: "대상과 동일",
        requireLocalPort: "로컬 포트 필수",
        openAs: "다음으로 열기",
        openAsNone: "없음",
        save: "저장",
        copy: "복사",
        ...
        errors: {
          target: "포트 또는 host:port를 입력하세요",
          port: "포트는 1에서 65535 사이여야 합니다",
        },
        states: {
          starting: "시작 중",
          waiting: "Host 대기 중",
      ...
      instructionFiles: {
        sectionTitle: "지시 파일",
        hint: "이 Host에서 Provider가 사용자 범위로부터 이미 로드하는 마크다운 파일입니다.",
        appliesAfterSave: "편집 내용은 저장 후 시작한 Agent 세션에 적용됩니다.",
        unavailable: "지시 파일을 편집하려면 이 호스트에 연결하세요",
        unsupported: "지시 파일을 편집하려면 이 호스트를 업데이트하세요",
        empty: "이 호스트에 지시 파일이 없습니다.",
        missing: "없음",
        providers: "{{providers}}에서 로드",
        loadFailed: "이 지시 파일을 불러올 수 없습니다.",
        accessibilityLabel: "사용자 지시 파일 {{filename}}",
        placeholder: "Provider가 이 파일에서 로드하는 지시.",
        reset: "재설정",
        save: "저장",
        saving: "저장하는 중...",
        saveFailed: "이 지시 파일을 저장할 수 없습니다.",
        conflictTitle: "디스크의 파일이 변경됨",
        conflictDescription: "현재 파일을 다시 불러오거나 초안으로 덮어쓰세요.",
        reload: "다시 불러오기",
        overwrite: "덮어쓰기",
      },
      agents: {
