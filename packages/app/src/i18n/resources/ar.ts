...
export const ar: TranslationResources = {
  ...
  workspace: {
    ...
    scripts: {
      ...
      accessibility: {
        ...
        forwardPort: "إعادة توجيه منفذ {{scriptName}}",
  ...
  settings: {
    ...
    sections: {
      ...
      appearance: "مظهر",
      editor: "المحرر",
      savedPrompts: "المطالبات المحفوظة",
    ...
    savedPrompts: {
      ...
      listTitle: "المطالبات",
      add: "إضافة مطالبة محفوظة",
      newPrompt: "مطالبة جديدة",
      empty: "لا توجد مطالبات محفوظة بعد",
      saveError: "تعذر حفظ المطالبات",
      automaticSending: {
        label: "الإرسال التلقائي",
        description: "إرسال المطالبة المحفوظة فور تحديدها",
      },
      actions: {
        reorder: "إعادة ترتيب {{name}}",
        reorderHint: "اسحب لتغيير موضعها",
      ...
      remove: {
        title: "إزالة {{name}}؟",
        message: "سيؤدي هذا إلى إزالة المطالبة المحفوظة من هذا العميل.",
        confirm: "إزالة",
      },
      validation: {
        nameRequired: "الاسم مطلوب",
        nameDuplicate: "يجب أن يكون الاسم فريدًا",
        bodyRequired: "يجب أن تحتوي المطالبة على نص",
      },
      form: {
        createTitle: "مطالبة محفوظة جديدة",
        editTitle: "تحرير المطالبة المحفوظة",
        nameLabel: "الاسم",
        namePlaceholder: "اسم قصير يسهل تمييزه",
        bodyLabel: "المطالبة",
        bodyPlaceholder: "نص مطالبة قابل لإعادة الاستخدام",
        save: "حفظ",
        saving: "جارٍ الحفظ...",
      },
    },
    ...
    host: {
      ...
      ports: {
        title: "المنافذ",
        sectionTitle: "إعادة توجيه المنافذ",
        add: "إضافة إعادة توجيه",
        addTitle: "إعادة توجيه منفذ جديدة",
        editTitle: "تعديل إعادة توجيه المنفذ",
        target: "عنوان الـ Host",
        label: "التسمية",
        localPort: "المنفذ المحلي",
        localPortPlaceholder: "نفس الهدف",
        requireLocalPort: "إلزام المنفذ المحلي",
        openAs: "فتح كـ",
        openAsNone: "بدون",
        save: "حفظ",
        copy: "نسخ",
        ...
        errors: {
          target: "استخدم منفذًا أو host:port",
          port: "يجب أن يكون المنفذ بين 1 و65535",
        },
        states: {
          starting: "يبدأ",
          waiting: "في انتظار الـ Host",
          updateHost: "يلزم تحديث الـ Host",
          ready: "جاهز",
          unavailable: "المنفذ غير متاح",
          error: "خطأ",
        },
      },
      connections: {
      ...
      instructionFiles: {
        sectionTitle: "ملفات التعليمات",
        hint: "ملفات ماركداون يحمّلها Provider بالفعل من نطاق المستخدم على هذا المضيف.",
        appliesAfterSave: "تُطبَّق التعديلات على جلسات الوكيل التي تبدأ بعد الحفظ.",
        unavailable: "اتصل بهذا المضيف لتحرير ملفات التعليمات",
        unsupported: "حدّث هذا المضيف لتحرير ملفات التعليمات",
        empty: "لا توجد ملفات تعليمات على هذا المضيف.",
        missing: "غير موجود",
        providers: "يحمّله {{providers}}",
        loadFailed: "تعذر تحميل ملف التعليمات هذا.",
        accessibilityLabel: "ملف تعليمات المستخدم {{filename}}",
        placeholder: "التعليمات التي يحمّلها Provider من هذا الملف.",
        reset: "إعادة ضبط",
        save: "حفظ",
        saving: "جارٍ الحفظ...",
        saveFailed: "تعذر حفظ ملف التعليمات هذا.",
        conflictTitle: "تغير الملف على القرص",
        conflictDescription: "أعد تحميل الملف الحالي أو اكتب فوقه بمسودتك.",
        reload: "إعادة تحميل",
        overwrite: "كتابة فوق",
      },
      agents: {
