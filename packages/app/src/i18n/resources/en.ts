  ...
  workspace: {
    ...
    scripts: {
      ...
      accessibility: {
        ...
        forwardPort: "Forward Port for {{scriptName}}",
  ...
  settings: {
    ...
    savedPrompts: {
      ...
      automaticSending: {
        ...
        description: "Send a saved prompt immediately when selected",
      },
      actions: {
        reorder: "Reorder {{name}}",
        reorderHint: "Drag to change its position",
        moveUp: "Move {{name}} up",
      ...
      remove: {
        title: "Remove {{name}}?",
        message: "This removes the saved prompt from this client.",
        confirm: "Remove",
      },
      validation: {
        nameRequired: "Name is required",
        nameDuplicate: "Name must be unique",
        bodyRequired: "Prompt must contain text",
      },
      form: {
        createTitle: "New saved prompt",
        editTitle: "Edit saved prompt",
        nameLabel: "Name",
        namePlaceholder: "Short recognizable name",
        bodyLabel: "Prompt",
        bodyPlaceholder: "Reusable prompt text",
        save: "Save",
        saving: "Saving...",
      },
    },
    ...
    host: {
      ...
      ports: {
        title: "Ports",
        sectionTitle: "Port Forwards",
        add: "Add Port Forward",
        addTitle: "New Port Forward",
        editTitle: "Edit Port Forward",
        target: "Host address",
        label: "Label",
        localPort: "Local port",
        localPortPlaceholder: "Same as target",
        requireLocalPort: "Require local port",
        openAs: "Open as",
        openAsNone: "None",
        save: "Save",
        copy: "Copy",
        ...
        errors: {
          target: "Use a port or host:port",
      ...
      instructionFiles: {
        sectionTitle: "Instruction files",
        hint: "Markdown files a Provider already loads from user scope on this Host.",
        appliesAfterSave: "Edits apply to Agent sessions started after save.",
        unavailable: "Connect to this host to edit Instruction files",
        unsupported: "Update this host to edit Instruction files",
        empty: "No Instruction files on this host.",
        missing: "Missing",
        providers: "Loaded by {{providers}}",
        loadFailed: "Unable to load this Instruction file.",
        accessibilityLabel: "User instruction file {{filename}}",
        placeholder: "Instructions the Provider loads from this file.",
        reset: "Reset",
        save: "Save",
        saving: "Saving...",
        saveFailed: "Unable to save this Instruction file.",
        conflictTitle: "File changed on disk",
        conflictDescription: "Reload the current file or overwrite it with your draft.",
        reload: "Reload",
        overwrite: "Overwrite",
      },
      agents: {
