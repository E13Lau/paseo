...
export const es: TranslationResources = {
  ...
  workspace: {
    ...
    scripts: {
      ...
      accessibility: {
        ...
        forwardPort: "Reenviar puerto de {{scriptName}}",
  ...
  settings: {
    ...
    savedPrompts: {
      ...
      listTitle: "Prompts",
      add: "Añadir prompt guardado",
      newPrompt: "Nuevo prompt",
      empty: "Aún no hay prompts guardados",
      saveError: "No se pudieron guardar los prompts",
      automaticSending: {
        label: "Envío automático",
        description: "Enviar un prompt guardado al seleccionarlo",
      },
      actions: {
        reorder: "Reordenar {{name}}",
        reorderHint: "Arrastra para cambiar su posición",
        moveUp: "Subir {{name}}",
        moveDown: "Bajar {{name}}",
        edit: "Editar {{name}}",
      ...
      remove: {
        title: "¿Eliminar {{name}}?",
        message: "Esto elimina el prompt guardado de este cliente.",
        confirm: "Eliminar",
      },
      validation: {
        nameRequired: "El nombre es obligatorio",
        nameDuplicate: "El nombre debe ser único",
        bodyRequired: "El prompt debe contener texto",
      },
      form: {
        createTitle: "Nuevo prompt guardado",
        editTitle: "Editar prompt guardado",
        nameLabel: "Nombre",
        namePlaceholder: "Nombre corto y reconocible",
        bodyLabel: "Prompt",
        bodyPlaceholder: "Texto reutilizable del prompt",
        save: "Guardar",
        saving: "Guardando...",
      },
    },
    ...
    host: {
      ...
      ports: {
        title: "Puertos",
        sectionTitle: "Reenvíos de puerto",
        add: "Añadir reenvío",
        addTitle: "Nuevo reenvío de puerto",
        editTitle: "Editar reenvío de puerto",
        target: "Dirección del Host",
        label: "Etiqueta",
        localPort: "Puerto local",
        localPortPlaceholder: "Igual que el destino",
        requireLocalPort: "Exigir puerto local",
        openAs: "Abrir como",
        openAsNone: "Ninguno",
        save: "Guardar",
        copy: "Copiar",
        ...
        errors: {
          target: "Usa un puerto o host:puerto",
          port: "El puerto debe estar entre 1 y 65535",
        },
        states: {
          starting: "Iniciando",
          waiting: "Esperando al Host",
          updateHost: "Hay que actualizar el Host",
          ready: "Listo",
          unavailable: "Puerto no disponible",
          error: "Error",
        },
      },
      connections: {
      ...
      instructionFiles: {
        sectionTitle: "Archivos de instrucciones",
        hint: "Archivos markdown que un Provider ya carga del ámbito de usuario en este Host.",
        appliesAfterSave:
          "Los cambios se aplican a las sesiones de agente iniciadas después de guardar.",
        unavailable: "Conéctate a este host para editar los archivos de instrucciones",
        unsupported: "Actualiza este host para editar los archivos de instrucciones",
        empty: "No hay archivos de instrucciones en este host.",
        missing: "Falta",
        providers: "Lo cargan {{providers}}",
        loadFailed: "No se pudo cargar este archivo de instrucciones.",
        accessibilityLabel: "Archivo de instrucciones de usuario {{filename}}",
        placeholder: "Instrucciones que el Provider carga desde este archivo.",
        reset: "Restablecer",
        save: "Guardar",
        saving: "Guardando...",
        saveFailed: "No se pudo guardar este archivo de instrucciones.",
        conflictTitle: "El archivo cambió en el disco",
        conflictDescription: "Recarga el archivo actual o sobrescríbelo con tu borrador.",
        reload: "Recargar",
        overwrite: "Sobrescribir",
      },
      agents: {
