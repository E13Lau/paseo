...
export const fr: TranslationResources = {
  ...
  workspace: {
    ...
    scripts: {
      ...
      accessibility: {
        ...
        forwardPort: "Transférer le port de {{scriptName}}",
  ...
  settings: {
    ...
    savedPrompts: {
      ...
      listTitle: "Prompts",
      add: "Ajouter un prompt enregistré",
      newPrompt: "Nouveau prompt",
      empty: "Aucun prompt enregistré",
      saveError: "Impossible d’enregistrer les prompts",
      automaticSending: {
        label: "Envoi automatique",
        description: "Envoyer immédiatement un prompt sélectionné",
      },
      actions: {
        reorder: "Réorganiser {{name}}",
        reorderHint: "Faites glisser pour changer sa position",
        moveUp: "Monter {{name}}",
      ...
      remove: {
        ...
        message: "Le prompt enregistré sera supprimé de ce client.",
        confirm: "Supprimer",
      },
      validation: {
        nameRequired: "Le nom est requis",
        nameDuplicate: "Le nom doit être unique",
        bodyRequired: "Le prompt doit contenir du texte",
      },
      form: {
        createTitle: "Nouveau prompt enregistré",
        editTitle: "Modifier le prompt enregistré",
        nameLabel: "Nom",
        namePlaceholder: "Nom court et reconnaissable",
        bodyLabel: "Prompt",
        bodyPlaceholder: "Texte de prompt réutilisable",
        save: "Enregistrer",
        saving: "Enregistrement...",
      },
    },
    ...
    host: {
      ...
      ports: {
        title: "Ports",
        sectionTitle: "Transferts de port",
        add: "Ajouter un transfert",
        addTitle: "Nouveau transfert de port",
        editTitle: "Modifier le transfert de port",
        target: "Adresse du Host",
        label: "Libellé",
        localPort: "Port local",
        localPortPlaceholder: "Identique à la cible",
        requireLocalPort: "Exiger le port local",
        openAs: "Ouvrir en",
        openAsNone: "Aucun",
        save: "Enregistrer",
        copy: "Copier",
        ...
        errors: {
          target: "Utilisez un port ou hôte:port",
          port: "Le port doit être entre 1 et 65535",
        },
        states: {
          starting: "Démarrage",
          waiting: "En attente du Host",
          updateHost: "Mise à jour du Host requise",
          ready: "Prêt",
          unavailable: "Port indisponible",
          error: "Erreur",
        },
      },
      connections: {
      ...
      instructionFiles: {
        sectionTitle: "Fichiers d'instructions",
        hint: "Fichiers markdown qu'un Provider charge déjà depuis la portée utilisateur de cet hôte.",
        appliesAfterSave:
          "Les modifications s'appliquent aux sessions d'agent démarrées après l'enregistrement.",
        unavailable: "Connectez-vous à cet hôte pour modifier les fichiers d'instructions",
        unsupported: "Mettez à jour cet hôte pour modifier les fichiers d'instructions",
        empty: "Aucun fichier d'instructions sur cet hôte.",
        missing: "Absent",
        providers: "Chargé par {{providers}}",
        loadFailed: "Impossible de charger ce fichier d'instructions.",
        accessibilityLabel: "Fichier d'instructions utilisateur {{filename}}",
        placeholder: "Instructions que le Provider charge depuis ce fichier.",
        reset: "Réinitialiser",
        save: "Sauvegarder",
        saving: "Sauvegarde...",
        saveFailed: "Impossible d'enregistrer ce fichier d'instructions.",
        conflictTitle: "Le fichier a changé sur le disque",
        conflictDescription: "Rechargez le fichier actuel ou écrasez-le avec votre brouillon.",
        reload: "Recharger",
        overwrite: "Écraser",
      },
      agents: {
