...
export const ja: TranslationResources = {
  ...
  workspace: {
    ...
    scripts: {
      ...
      accessibility: {
        ...
        forwardPort: "{{scriptName}}のポートを転送",
  ...
  settings: {
    ...
    savedPrompts: {
      ...
      add: "保存済みプロンプトを追加",
      newPrompt: "新しいプロンプト",
      empty: "保存済みプロンプトはありません",
      saveError: "保存済みプロンプトを保存できません",
      automaticSending: {
        label: "自動送信",
        description: "保存済みプロンプトを選択するとすぐに送信します",
      },
      actions: {
        reorder: "{{name}}を並べ替え",
        reorderHint: "ドラッグして位置を変更",
        moveUp: "{{name}}を上へ移動",
        moveDown: "{{name}}を下へ移動",
        edit: "{{name}}を編集",
        remove: "{{name}}を削除",
      ...
      remove: {
        title: "{{name}}を削除しますか？",
        message: "このクライアントから保存済みプロンプトを削除します。",
        confirm: "削除",
      },
      validation: {
        nameRequired: "名前は必須です",
        nameDuplicate: "名前は一意である必要があります",
        bodyRequired: "プロンプトにテキストを入力してください",
      },
      form: {
        createTitle: "新しい保存済みプロンプト",
        editTitle: "保存済みプロンプトを編集",
        nameLabel: "名前",
        namePlaceholder: "短く識別しやすい名前",
        bodyLabel: "プロンプト",
        bodyPlaceholder: "再利用するプロンプトテキスト",
        save: "保存",
        saving: "保存中...",
      },
    },
    ...
    host: {
      ...
      ports: {
        ...
        label: "ラベル",
        localPort: "ローカルポート",
        localPortPlaceholder: "ターゲットと同じ",
        requireLocalPort: "ローカルポートを必須にする",
        openAs: "開く形式",
        openAsNone: "なし",
        save: "保存",
        copy: "コピー",
        ...
        errors: {
          target: "ポートまたは host:port を入力",
          port: "ポートは 1〜65535 です",
        },
        states: {
          starting: "開始中",
          waiting: "Hostを待っています",
      ...
      instructionFiles: {
        sectionTitle: "指示ファイル",
        hint: "この Host 上で Provider がユーザースコープから読み込む Markdown ファイルです。",
        appliesAfterSave: "編集は保存後に開始した Agent セッションに適用されます。",
        unavailable: "指示ファイルを編集するにはこのホストに接続してください",
        unsupported: "指示ファイルを編集するにはこのホストを更新してください",
        empty: "このホストに指示ファイルはありません。",
        missing: "未作成",
        providers: "{{providers}} が読み込みます",
        loadFailed: "この指示ファイルを読み込めませんでした。",
        accessibilityLabel: "ユーザー指示ファイル {{filename}}",
        placeholder: "Provider がこのファイルから読み込む指示。",
        reset: "リセット",
        save: "保存",
        saving: "保存中...",
        saveFailed: "この指示ファイルを保存できませんでした。",
        conflictTitle: "ディスク上のファイルが変更されました",
        conflictDescription: "現在のファイルを再読み込みするか、下書きで上書きしてください。",
        reload: "再読み込み",
        overwrite: "上書き",
      },
      agents: {
